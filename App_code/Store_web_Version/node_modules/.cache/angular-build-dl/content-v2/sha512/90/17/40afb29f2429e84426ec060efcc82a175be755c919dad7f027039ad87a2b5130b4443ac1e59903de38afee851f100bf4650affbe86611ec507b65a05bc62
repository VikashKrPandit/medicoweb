      ...
      _createClass(ManageOrdersComponent, [{
        ...
        value: function getDrivers() {
          ...
          if (this.util.storeInfo && this.util.storeInfo.cid) {
            ...
            this.api.post_private('drivers/geyByCity', param).then(function (data) {
          ...
          this.api.post_private('orders/getById', param).then(function (data) {
            ...
            if (data && data.status === 200 && data.data.length > 0) {
              ...
              if (info.uid) {
                ...
                _this3.api.post_private('users/getById', userinfo).then(function (data) {
        ...
        value: function close() {
          ...
          if (driver && driver.length > 0) {
            ...
            if (this.drivers && this.drivers.length) {
              ...
              console.log('===================================', param);
              this.api.post_private('orders/editList', param).then(function (data) {
        ...
        value: function updateDriver(uid, value) {
          ...
          this.api.post_private('drivers/edit_profile', param).then(function (data) {
            console.log(data);
          }, function (error) {
            console.log(error);
          });
        ...
        value: function changeOrderStatus() {
          ...
          if (this.changeStatusOrder) {
            ...
            if (this.changeStatusOrder !== 'ongoing' && this.orderAt === 'home' && this.driverId !== '0') {
              ...
              this.api.post_private('orders/editList', _param).then(function (data) {
                console.log('order', data);
